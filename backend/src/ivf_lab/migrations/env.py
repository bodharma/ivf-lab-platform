...
# Importing Base from domain models triggers discovery of all ORM models via __init__.py
from ivf_lab.domain.models import Base  # noqa: F401
...
def run_migrations_offline() -> None:
    ...
    context.execute() emit SQL to a script output.
    """
